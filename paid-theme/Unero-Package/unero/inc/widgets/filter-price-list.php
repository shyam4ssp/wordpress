...
if ( ! class_exists( 'Unero_Price_Filter_List_Widget' ) ) {
	 ...
	 * @see   WP_Widget
	 */
	class Unero_Price_Filter_List_Widget extends WP_Widget {
		...
		public function __construct() {
			$widget_ops  = array(
				'classname'   => 'widget_text unero-price-filter-list',
				'description' => esc_html__( 'Shows a price filter list in a widget which lets you narrow down the list of shown products when viewing product categories.', 'unero' ),
			);
			$control_ops = array( 'width' => 400, 'height' => 350 );
			parent::__construct( 'unero-price-filter-list', esc_html__( 'Unero Price Filter List', 'unero' ), $widget_ops, $control_ops );
		}
		...
		public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'text' ) ); ?>"><?php esc_html_e( 'Content:', 'unero' ); ?></label>
            ...
            <p><?php esc_html_e( 'Enter the price by format: min_price|max_price. Divide price list with linebreaks (Enter). Example:', 'unero' ); ?></p>
            <p><?php esc_html_e( '100|200', 'unero' ); ?><br><?php esc_html_e( '200|300', 'unero' ); ?>
                <br><?php esc_html_e( '300|400', 'unero' ); ?></p>
			<?php
		}
	}
}