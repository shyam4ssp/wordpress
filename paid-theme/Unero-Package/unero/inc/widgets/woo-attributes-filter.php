...
if ( ! class_exists( 'Unero_Widget_Attributes_Filter' ) ) {
	 ...
	 * @extends  WC_Widget
	 */
	class Unero_Widget_Attributes_Filter extends WC_Widget {

		/**
		 * Constructor.
		 */
		public function __construct() {
			$this->widget_cssclass    = 'woocommerce unero_attributes_filter widget_layered_nav';
			$this->widget_description = esc_html__( 'Shows a custom attribute in a widget which lets you narrow down the list of products when viewing product categories.', 'unero' );
			$this->widget_id          = 'unero_attributes_filter';
			$this->widget_name        = esc_html__( 'Unero Attributes Filter', 'unero' );
			parent::__construct();
		}
		...
		public function init_settings() {
			...
			$this->settings = array(
				'title'      => array(
					'type'  => 'text',
					'std'   => esc_html__( 'Filter by', 'unero' ),
					'label' => esc_html__( 'Title', 'unero' )
				),
				'attribute'  => array(
					'type'    => 'select',
					'std'     => '',
					'label'   => esc_html__( 'Attribute', 'unero' ),
					'options' => $attribute_array
				),
				'query_type' => array(
					'type'    => 'select',
					'std'     => 'and',
					'label'   => esc_html__( 'Query type', 'unero' ),
					'options' => array(
						'and' => esc_html__( 'AND', 'unero' ),
						'or'  => esc_html__( 'OR', 'unero' )
					)
				),
			);
		}
		...
		protected function layered_nav_list( $terms, $taxonomy, $query_type, $show_color ) {
			...
			foreach ( $terms as $term ) {
				...
				echo apply_filters( 'unero_color_filter_nav_count', '<span class="count">' . absint( $count ) . '</span>', $count, $term );
